...
if __name__ == '__main__':
    for i in range(epoch):
        ...
        for data in train_dataloader:
            ...
            if total_train_step % accumulation_steps == 0:
                # 在累积的步数上执行参数更新
                optimizer.step()
                optimizer.zero_grad()
            ...
            if total_train_step % 1000 == 0:
                print("训练次数：{}，Loss:{}".format(total_train_step, total_loss * accumulation_steps))
                writer.add_scalar('train_loss', total_loss * accumulation_steps, total_train_step)
                total_loss = 0
